...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   priorityRegexes: () => (/* binding */ priorityRegexes)\n/* harmony export */ });\n/* harmony import */ var _services_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/constants */ \"./src/services/constants.ts\");\n\nconst priorityRegexes = [\n    { type: _services_constants__WEBPACK_IMPORTED_MODULE_0__.OperatorType.UNARY, regExp: new RegExp(`(\\\\d+\\\\.?\\\\d*)\\\\s*(${_services_constants__WEBPACK_IMPORTED_MODULE_0__.MathOperators.FACTORIAL})`) },\n    { type: _services_constants__WEBPACK_IMPORTED_MODULE_0__.OperatorType.TRIGONOMETRIC, regExp: new RegExp(`(${_services_constants__WEBPACK_IMPORTED_MODULE_0__.MathOperators.COS}|${_services_constants__WEBPACK_IMPORTED_MODULE_0__.MathOperators.SIN}|${_services_constants__WEBPACK_IMPORTED_MODULE_0__.MathOperators.TAN})\\\\s*(-?\\\\d+\\\\.?\\\\d*)`, 'i') },\n    { type: _services_constants__WEBPACK_IMPORTED_MODULE_0__.OperatorType.BINARY, regExp: new RegExp(`(-?\\\\d+\\\\.?\\\\d*)\\\\s*(${_services_constants__WEBPACK_IMPORTED_MODULE_0__.MathOperators.DIVISION}|\\\\${_services_constants__WEBPACK_IMPORTED_MODULE_0__.MathOperators.MULTIPLICATION})\\\\s*(-?\\\\d+\\\\.?\\\\d*)`, 'i') },\n    { type: _services_constants__WEBPACK_IMPORTED_MODULE_0__.OperatorType.BINARY, regExp: new RegExp(`(-?\\\\d+\\\\.?\\\\d*)\\\\s*(\\\\+|\\\\-)\\\\s*(-?\\\\d+\\\\.?\\\\d*)`) },\n];\n\n\n//# sourceURL=webpack://new/./src/regex/priorityRegexes.ts?");
