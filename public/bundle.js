...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Associativity: () => (/* reexport safe */ _constants__WEBPACK_IMPORTED_MODULE_0__.Associativity),\n/* harmony export */   CalculationMethods: () => (/* reexport safe */ _constants__WEBPACK_IMPORTED_MODULE_0__.CalculationMethods),\n/* harmony export */   Errors: () => (/* reexport safe */ _constants__WEBPACK_IMPORTED_MODULE_0__.Errors),\n/* harmony export */   FactorialProcessor: () => (/* reexport safe */ _regexCalculation_FactorialProcessor__WEBPACK_IMPORTED_MODULE_6__.FactorialProcessor),\n/* harmony export */   LeftBracketProcessor: () => (/* reexport safe */ _polishNotation_LeftBracketsProcessor__WEBPACK_IMPORTED_MODULE_2__.LeftBracketProcessor),\n/* harmony export */   MathOperationPriority: () => (/* reexport safe */ _constants__WEBPACK_IMPORTED_MODULE_0__.MathOperationPriority),\n/* harmony export */   MathOperators: () => (/* reexport safe */ _constants__WEBPACK_IMPORTED_MODULE_0__.MathOperators),\n/* harmony export */   OperatorProcessor: () => (/* reexport safe */ _polishNotation_OperatorProcessor__WEBPACK_IMPORTED_MODULE_3__.OperatorProcessor),\n/* harmony export */   OperatorType: () => (/* reexport safe */ _constants__WEBPACK_IMPORTED_MODULE_0__.OperatorType),\n/* harmony export */   PolishNotation: () => (/* reexport safe */ _polishNotation_PolishNotation__WEBPACK_IMPORTED_MODULE_4__.PolishNotation),\n/* harmony export */   RegexCalculation: () => (/* reexport safe */ _regexCalculation_RegexCalculation__WEBPACK_IMPORTED_MODULE_7__.RegexCalculation),\n/* harmony export */   RegularProcessor: () => (/* reexport safe */ _regexCalculation_RegularProcessor__WEBPACK_IMPORTED_MODULE_8__.RegularProcessor),\n/* harmony export */   RightBracketProcessor: () => (/* reexport safe */ _polishNotation_RightBracketsProcessor__WEBPACK_IMPORTED_MODULE_5__.RightBracketProcessor),\n/* harmony export */   SpecialOperators: () => (/* reexport safe */ _constants__WEBPACK_IMPORTED_MODULE_0__.SpecialOperators),\n/* harmony export */   TrigonometryProcessor: () => (/* reexport safe */ _regexCalculation_TrigonometryProcessor__WEBPACK_IMPORTED_MODULE_9__.TrigonometryProcessor),\n/* harmony export */   services: () => (/* reexport safe */ _servicesOptions__WEBPACK_IMPORTED_MODULE_1__.services)\n/* harmony export */ });\n/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ \"./src/services/constants.ts\");\n/* harmony import */ var _servicesOptions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./servicesOptions */ \"./src/services/servicesOptions.ts\");\n/* harmony import */ var _polishNotation_LeftBracketsProcessor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./polishNotation/LeftBracketsProcessor */ \"./src/services/polishNotation/LeftBracketsProcessor.ts\");\n/* harmony import */ var _polishNotation_OperatorProcessor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./polishNotation/OperatorProcessor */ \"./src/services/polishNotation/OperatorProcessor.ts\");\n/* harmony import */ var _polishNotation_PolishNotation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./polishNotation/PolishNotation */ \"./src/services/polishNotation/PolishNotation.ts\");\n/* harmony import */ var _polishNotation_RightBracketsProcessor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./polishNotation/RightBracketsProcessor */ \"./src/services/polishNotation/RightBracketsProcessor.ts\");\n/* harmony import */ var _regexCalculation_FactorialProcessor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./regexCalculation/FactorialProcessor */ \"./src/services/regexCalculation/FactorialProcessor.ts\");\n/* harmony import */ var _regexCalculation_RegexCalculation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./regexCalculation/RegexCalculation */ \"./src/services/regexCalculation/RegexCalculation.ts\");\n/* harmony import */ var _regexCalculation_RegularProcessor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./regexCalculation/RegularProcessor */ \"./src/services/regexCalculation/RegularProcessor.ts\");\n/* harmony import */ var _regexCalculation_TrigonometryProcessor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./regexCalculation/TrigonometryProcessor */ \"./src/services/regexCalculation/TrigonometryProcessor.ts\");\n\n\n\n\n\n\n\n\n\n\n\n\n//# sourceURL=webpack://new/./src/services/index.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   RegexCalculation: () => (/* binding */ RegexCalculation)\n/* harmony export */ });\n/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index */ \"./src/services/index.ts\");\n/* harmony import */ var _utils_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/index */ \"./src/utils/index.ts\");\n/* harmony import */ var _regex_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../regex/index */ \"./src/regex/index.ts\");\n\n\n\nclass RegexCalculation {\n    constructor(operations) {\n        this.availableOperators = operations;\n    }\n    findHighestPriorityOperatorResult(expression) {\n        const priorityRegexes = (0,_regex_index__WEBPACK_IMPORTED_MODULE_2__.getPrioritizedRegexes)((0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.getPriorityInfoArray)(this.availableOperators));\n        for (const priorityRegex of priorityRegexes) {\n            const matches = expression.match(priorityRegex.regExp);\n            if (matches) {\n                const operatorIndex = priorityRegex.type === _index__WEBPACK_IMPORTED_MODULE_0__.OperatorType.TRIGONOMETRIC ? 1 : 2;\n                return {\n                    subExpressionResult: this.availableOperators[matches[operatorIndex]].processorConstructor.process(matches),\n                    subExpressionMatch: matches[0],\n                };\n            }\n        }\n        return null;\n    }\n    calculate(tokens) {\n        const expression = tokens.join('');\n        const highestPriorityOperator = this.findHighestPriorityOperatorResult(expression);\n        if (!highestPriorityOperator) {\n            if (tokens.length === 1) {\n                return parseFloat(tokens[0]);\n            }\n            else {\n                throw new Error(_index__WEBPACK_IMPORTED_MODULE_0__.Errors.INVALID_EXPRESSION);\n            }\n        }\n        const updatedExpression = expression.replace(highestPriorityOperator.subExpressionMatch, highestPriorityOperator.subExpressionResult.toString());\n        const updatedTokens = updatedExpression.match(_regex_index__WEBPACK_IMPORTED_MODULE_2__.TOKENIZE_REGEX_PATTERN);\n        if (!updatedTokens) {\n            throw new Error(_index__WEBPACK_IMPORTED_MODULE_0__.Errors.INVALID_EXPRESSION);\n        }\n        if (updatedTokens[0] === _index__WEBPACK_IMPORTED_MODULE_0__.MathOperators.MINUS) {\n            updatedTokens.splice(0, 2, updatedTokens[0] + updatedTokens[1]);\n        }\n        return this.calculate(updatedTokens);\n    }\n    evaluateExpression(tokens) {\n        while (tokens.includes(_index__WEBPACK_IMPORTED_MODULE_0__.SpecialOperators.LEFT_BRACKET)) {\n            const match = tokens.join('').match(_regex_index__WEBPACK_IMPORTED_MODULE_2__.PARENTHESES_EXPRESSION);\n            if (!match) {\n                throw new Error(_index__WEBPACK_IMPORTED_MODULE_0__.Errors.UNMATCHED_PARENTHESES);\n            }\n            const subExpression = match[0].slice(1, -1);\n            const subResult = this.evaluate(subExpression);\n            tokens =\n                tokens.join('').replace(_regex_index__WEBPACK_IMPORTED_MODULE_2__.PARENTHESES_EXPRESSION, subResult.toString()).match(_regex_index__WEBPACK_IMPORTED_MODULE_2__.TOKENIZE_REGEX_PATTERN) || [];\n        }\n        tokens = [this.calculate(tokens).toString()];\n        if (tokens.length !== 1) {\n            throw new Error(_index__WEBPACK_IMPORTED_MODULE_0__.Errors.INVALID_EXPRESSION);\n        }\n        return parseFloat(tokens[0]);\n    }\n    evaluate(expression) {\n        if (expression.trim() === '') {\n            return 0;\n        }\n        const tokens = expression.match(_regex_index__WEBPACK_IMPORTED_MODULE_2__.TOKENIZE_REGEX_PATTERN);\n        const expressionWithoutSpaces = (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.reduceAllSpaces)(expression);\n        if (!tokens || tokens.join('') !== expressionWithoutSpaces) {\n            throw new Error(_index__WEBPACK_IMPORTED_MODULE_0__.Errors.INVALID_EXPRESSION);\n        }\n        return this.evaluateExpression(tokens);\n    }\n}\n\n\n//# sourceURL=webpack://new/./src/services/regexCalculation/RegexCalculation.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   escapeRegExp: () => (/* reexport safe */ _helpFunction__WEBPACK_IMPORTED_MODULE_0__.escapeRegExp),\n/* harmony export */   factorial: () => (/* reexport safe */ _helpFunction__WEBPACK_IMPORTED_MODULE_0__.factorial),\n/* harmony export */   getPriorityInfoArray: () => (/* reexport safe */ _helpFunction__WEBPACK_IMPORTED_MODULE_0__.getPriorityInfoArray),\n/* harmony export */   isMathOperator: () => (/* reexport safe */ _helpFunction__WEBPACK_IMPORTED_MODULE_0__.isMathOperator),\n/* harmony export */   reduceAllSpaces: () => (/* reexport safe */ _helpFunction__WEBPACK_IMPORTED_MODULE_0__.reduceAllSpaces)\n/* harmony export */ });\n/* harmony import */ var _helpFunction__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpFunction */ \"./src/utils/helpFunction.ts\");\n\n\n\n//# sourceURL=webpack://new/./src/utils/index.ts?");
