...
describe('mongoModel.unit', () => {
    ...
    const mockEntry = { expression: '2222+1111', result: 3333, lastRequestAt: new Date() }
    ...
    describe('updateEntry method', () => {
        it('should update an existing entry in the database', async () => {
            ...
            await mongoModel.updateEntry({ expression: mockEntry.expression }, { lastRequestAt: newDate });
    ...
    describe('findMany method', () => {
        ...
        it('should find limited entries sorted in asc', async () => {
            ...
            const expressions = await mongoModel.findMany(3, "lastRequestAt", ASC);
        ...
        it('should find limited entries sorted in desc', async () => {
            ...
            const expressions = await mongoModel.findMany(3, "lastRequestAt", DESC);
