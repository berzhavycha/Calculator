...
export const generateRemainingOperators = (rowArrayContainer: IButtonData[][], operations: string[], lastButtonRef: React.RefObject<HTMLButtonElement>, resizeContainer: (increaseWidthBy: number) => void): void => {
